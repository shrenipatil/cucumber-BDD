...
public class TestBase {
	...
	public TestBase()
	{
		...
		{
			prop=new Properties();
			FileInputStream ip=new FileInputStream("/Users/Inside/workspace/CucumberDemo/src/main/java/com/qa/cucumber/config/config.properties");
			prop.load(ip);
